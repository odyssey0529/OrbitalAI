...
LABEL_CONTOURS = [(0, 0, 0), (255, 255, 255)]
...
def test_bisenet_cityspaces(image_path, weights_path):
    ...
    for i in files_list:
        input_name = image_path + i
        output_name = '/home/im/bisenetv2-tensorflow/results/' + i
        # prepare input image
        src_image = cv2.imread(input_name, cv2.IMREAD_COLOR)
        ...
        with sess.as_default():
            ...
            cv2.imwrite(output_name, prediction_mask_color)
